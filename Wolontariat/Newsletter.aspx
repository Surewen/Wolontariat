...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <link rel="stylesheet" runat="server" media="screen" href="/css/Newsletter.css" />
    Grupa odbiorców:<br />
    ...
    Zawartość:<br />
              <asp:TextBox type="text" id="TextArea1" TextMode="multiline" class="form-control" required="required" autofocus="autofocus" runat="server"/><br /><br />
